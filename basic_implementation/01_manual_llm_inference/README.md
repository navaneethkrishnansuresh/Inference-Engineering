# Part 1: Manual LLM Inference From First Principles

This part starts with a small pretrained model and manually walks through the basic inference loop.
...
The aim is not to build a production server in one part. It is to make each piece of the inference path understandable before adding the systems concepts that build on it.
